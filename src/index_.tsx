...
ReactDOM.render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/" element={<React.StrictMode> <MainLayout></MainLayout>  </React.StrictMode>}></Route>
      <Route path="/userpage1" element={<React.StrictMode> <UserPage1></UserPage1>  </React.StrictMode>}></Route>
